...
bool is_periodic_balance_req;
bool is_pick_next_last_pick;


DEFINE_SPINLOCK(min_max_lock);
int highest_weight_cpu;
u64 highest_weight_among_cpus;
int s_highest_weight_cpu = 1;
u64 s_highest_weight_among_cpus;
int lowest_weight_cpu;
u64 lowest_weight_among_cpus;
int s_lowest_weight_cpu = 1;
u64 s_lowest_weight_among_cpus;

DEFINE_SPINLOCK(min_max_lock_v2);
int D_lowest_weight_cpu;
u64 D_lowest_weight_among_cpus;
int D_s_lowest_weight_cpu = 1;
u64 D_s_lowest_weight_among_cpus;
...
static void update_dMax(struct rq *rq)
{
	...
	if ((D_lowest_weight_cpu == this_cpu) || (D_s_lowest_weight_cpu == this_cpu)) {
		...
		else if (D_s_lowest_weight_among_cpus < this_cpu_wfq_weight)
...
static void update_min_max_cpu_buf(struct rq *rq)
{
	...
	if ((highest_weight_cpu == this_cpu) || (s_highest_weight_cpu == this_cpu)) {
		...
		else if (s_highest_weight_among_cpus < this_cpu_wfq_weight)
	...
	if ((lowest_weight_cpu == this_cpu) || (s_lowest_weight_cpu == this_cpu)) {
		...
		else if (s_lowest_weight_among_cpus > this_cpu_wfq_weight)
